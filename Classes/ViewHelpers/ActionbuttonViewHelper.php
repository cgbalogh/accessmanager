...
class ActionbuttonViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('buttontext', 'string', 'Button text', false, false);
